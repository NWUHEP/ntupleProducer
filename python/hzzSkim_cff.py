...
DIMUON_CUT=("mass > 40 && max(daughter(0).pt, daughter(1).pt) > 20 && min (daughter(0).pt,daughter(1).pt) > 7")
DIELECTRON_CUT=("mass > 40 && max(daughter(0).pt, daughter(1).pt) > 20 && min (daughter(0).pt,daughter(1).pt) > 10")
