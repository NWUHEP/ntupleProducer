...
+                      "&& hadTowOverEm                < 0.05"
+                      "&& hasPixelSeed                == 0"
+                      "&& ecalRecHitSumEtConeDR03           < 4.2 + 0.006*pt"
+                      "&& hcalTowerSumEtConeDR03            < 2.2 + 0.0025*pt"
+                      "&& trkSumPtHollowConeDR03            < 2.0 + 0.001*pt"
                   ),
...
isophotonseq   = cms.Sequence(isophotons)
